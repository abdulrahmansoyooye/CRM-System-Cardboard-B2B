...
// Admin Routes
router.post('/admin/assets', (0, auth_middleware_1.authMiddleware)(['admin', 'super_admin']), upload_middleware_1.uploadSingle, (0, validate_middleware_1.validateRequest)(asset_validation_1.createAssetSchema), asset_controller_1.AssetController.create);
