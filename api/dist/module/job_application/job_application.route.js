...
const job_application_validation_1 = require("./job_application.validation");
const router = (0, express_1.Router)();
// Public Routes
router.post('/jobs/apply', (0, validate_middleware_1.validateRequest)(job_application_validation_1.Job_applicationValidation.createJob_applicationSchema), job_application_controller_1.JobApplicationController.create);
// Admin Routes
...
router.put('/admin/applications/:id', (0, auth_middleware_1.authMiddleware)(['admin', 'super_admin']), (0, validate_middleware_1.validateRequest)(job_application_validation_1.Job_applicationValidation.updateJob_applicationSchema), job_application_controller_1.JobApplicationController.update);
