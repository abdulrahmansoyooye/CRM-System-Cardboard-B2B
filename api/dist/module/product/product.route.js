...
router.get('/products', (0, auth_middleware_1.default)(['admin']), product_controller_1.ProductController.getAll);
router.get('/products/slug', (0, auth_middleware_1.default)(['admin']), product_controller_1.ProductController.getBySlug);
