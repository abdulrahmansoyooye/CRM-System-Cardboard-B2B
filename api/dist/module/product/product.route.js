...
router.put('/admin/products/:id', (0, auth_middleware_1.default)(['admin']), (0, validate_middleware_1.validateRequest)(product_validation_1.ProductValidation.updateProductSchema), product_controller_1.ProductController.update);
