...
// Admin Routes
router.post('/admin/blogs', (0, auth_middleware_1.authMiddleware)(['admin', 'super_admin']), blog_controller_1.BlogController.create);
router.put('/admin/blogs/:id', (0, auth_middleware_1.authMiddleware)(['admin', 'super_admin']), blog_controller_1.BlogController.update);
