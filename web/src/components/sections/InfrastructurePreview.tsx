...
export function InfrastructurePreview() {
  ...
  return (
    <section ref={containerRef} className="py-40 bg-[#0A0F1A] text-white overflow-hidden relative border-t border-white/5">
      ...
      <div className="absolute left-1/2 top-0 bottom-0 w-px bg-white/3 -translate-x-1/2 hidden lg:block" />
      ...
      <div className="container mx-auto px-4 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row gap-24 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8">
              {CAPABILITIES.map((cap, idx) => (
                ...
                >
                  <div className="w-12 h-12 bg-white/3 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-accent group-hover:border-accent transition-all duration-500">
                  ...
                  <div>
                    ...
                    <div className="w-full h-px bg-white/5 group-hover:bg-accent/20 transition-colors" />
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          {/* Right Images Layout */}
          <div className="lg:w-1/2 relative min-h-175 w-full mt-20 lg:mt-0">
            <motion.div 
              style={{ y: y1 }}
