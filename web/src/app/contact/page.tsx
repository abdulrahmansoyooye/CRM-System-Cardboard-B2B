            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground font-medium leading-relaxed">
                    Sales inquiries: sales@cardbox.demo
                    <br />
                    Export inquiries: global@cardbox.demo
                    <br />
          ...
          <div className="bg-secondary/50 p-8 border border-border rounded-sm shadow-sm relative overflow-hidden">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <select className="w-full h-12 rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
