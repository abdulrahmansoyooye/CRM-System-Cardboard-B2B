...
import { User, Mail, Phone, Building, Calendar, CheckCircle2, FileText, Download, ShieldCheck, Clock, Trash2 } from "lucide-react";
        ...
        <div className="w-full md:w-72 space-y-6">
          ...
          <div className="flex flex-col gap-3">
             ...
             <div className="grid grid-cols-2 gap-3">
                ...
                <button onClick={onDelete} className="flex items-center justify-center gap-2 py-4 rounded-2xl bg-rose-50 text-rose-500 font-black uppercase text-[9px] tracking-widest hover:bg-rose-500 hover:text-white transition-all">
